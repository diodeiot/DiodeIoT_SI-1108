...
/*
  ...
  7. İndirdiğiniz MQTT client programından topic olarak SI1108-[mac adresi]/relay yazın. [mac adresi] alanı seri konsoldan görebileceğiz ESP32'nin mac adresi
  olmalıdır. Örneğin SI1108-4C11AECCB9D0/relay
...
void mqttConnect(void)
{
  ...
  while(!mqttClient.connected())
  {
    ...
    String clientId = "SI1108-" + getMacAddress();
